...
# Important to download the library of our trasnformers from hugging face hub
...
df1=pd.read_excel('resources/ClearCO2_dataset.xlsx').astype(str)
df2=pd.read_excel('resources/food_related_emissions.xlsx',usecols=['ProductTypeName_of_hiot', 'ProductTypeName'])
...
matches_df = pd.DataFrame(product_matches, columns=['Codex Merged Input', 'Matched Category'])
...
matches_df.to_excel('google_forms/outputs/merged_approach_All.xlsx', index=False)