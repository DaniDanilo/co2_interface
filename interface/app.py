...
from config import reference_db, result_column, sentence_transformers_model, emissions_source_name, emissions_source, left_on, right_on
...
def run_interface(merged_categories):
     def pipeline(input):
          ...
          carbon_footprint, max_emission_product = calculate_emissions(emissions_source_name,
                                                                      emissions_source, matching_outputs, left_on, right_on)
